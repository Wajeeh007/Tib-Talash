...
import 'screens/user_screens/widgets/specialist_button.dart';
import 'screens/user_screens/widgets/doctor_details.dart';
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('$specialization', style: TextStyle(fontSize: 22.0, color: Colors.black45, fontWeight: FontWeight.w600),),
                SizedBox(
                  height: 7.0,
                ),
                Text('At', style: TextStyle(fontSize: 11.5, fontWeight: FontWeight.w500),),
                SizedBox(
                  height: 2.0,
                ),
                Text('$hospital', style: TextStyle(fontSize: 15.5, fontWeight: FontWeight.w700),),
              ],
            ),
          ),
          Padding(
